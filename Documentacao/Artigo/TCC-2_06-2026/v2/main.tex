...
\title{Digitalização da Caderneta da Gestante: Uma Arquitetura de IA Responsável para Apoio Documental e Informacional no Pré-Natal}
...
A documentação clínica no \textit{Sistema Único de Saúde} (SUS) combina registros em sistemas digitais e instrumentos físicos, como fichas de pré-natal e a Caderneta da Gestante \cite{FichaPreNatal2018, CadernetaGestante2024}.
...
Todo o conteúdo obtido de forma automatizada foi revisado e editado conforme necessário, sob total responsabilidade do autor.
