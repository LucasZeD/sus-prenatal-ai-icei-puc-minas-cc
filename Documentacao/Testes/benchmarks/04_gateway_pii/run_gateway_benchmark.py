...
from paths import CLINICAL_AI_ROOT, PII_CORPUS, gateway_dir  # noqa: E402
...
from paths import CLINICAL_AI_ROOT, gateway_dir  # noqa: E402
...
def main() -> int:
    ...
    out_dir = args.out_dir or gateway_dir(stamp)
