...
from paths import figures_dir, roteiro_dir  # noqa: E402
...
def main() -> int:
    ...
    csv_path = args.csv or (roteiro_dir(args.date) / "roteiro_results.csv")
    out_dir = args.out_dir or figures_dir(args.date)
